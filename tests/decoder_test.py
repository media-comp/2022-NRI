...
model = MLPDecoder(args.node_dims, args.sep_hidden_dims, args.sep_out_dims, args.edge_types, args.hidden_dims,
                   args.dropout)
...
rel_type_onehot = torch.FloatTensor(test_series.size(0), rec_mask.size(0), args.edge_types).to(device)
